  ...
  return (
    <section id="tecnologias" className="tecnologias-section my-5">
      ...
      <div className="container d-flex flex-wrap justify-content-center align-items-center gap-4">
        <img src="/public/ANSYS_logo.png" alt="ANSYS Fluent" className="tech-logo" />
        <img src="/public/CMG.png" alt="CMG" className="tech-logo" />
        <img src="/public/MRST.png" alt="MRST" className="tech-logo" />
        <img src="/public/DARTS.png" alt="DARTS" className="tech-logo" />
